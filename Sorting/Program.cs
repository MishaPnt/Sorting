...
namespace Sorting
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] myArray4 = new int[countOfNumbs1];
            TSorting tMerge1 = new TMergeSort(myArray4, sortByAsc);
            Random random4 = new Random();
            for (int i = 0; i < myArray4.Length; i++)
            {
                myArray4[i] = random4.Next(0, 50000);
            }
            sw3.Start();
            myArray4 = tMerge1.Sort();
            sw3.Stop();
            Console.WriteLine("Вивiд вiдсортованого масиву сортировкою зливанням: ");
            Console.WriteLine("Таймер");
            Console.WriteLine("Мiлiсекунд: " + sw3.ElapsedMilliseconds);
        }
    }
}
